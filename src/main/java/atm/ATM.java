...
public class ATM {
	...
	/**
	 * Finds customer.txt in bank.
	 * @param id current customer.txt id
	...
	/**
	 * Transfer from current customer.txt to the customer.txt with
	 * customer.txt id in the parameter
	 * @param receivingId receiver customer.txt
