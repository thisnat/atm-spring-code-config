...
public class DataSourceFile implements DataSource {
    ...
    /**
     * @param filename the name of the customer.txt file
     */
    ...
    /**
     * Reads the customer.txt numbers and pins
    ...
    public Map<Integer,Customer> readCustomers() {
        ...
        try {
            ...
            System.err.println("Problem reading a customer.txt file: "+filename);
            return customers;
        }
